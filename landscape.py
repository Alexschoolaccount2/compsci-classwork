...
while running:
    ...
    (85, head_y + 15), (135, head_y + 15),  
    (130, head_y + 65), (110, head_y + 45),  
    (90, head_y + 65), (85, head_y + 15)     
])
    ...
    pygame.draw.polygon(screen, (0, 0, 0), [
        (witch_x+3, 150), (witch_x + 15, 138), (witch_x + 30, 150) 
    ])

    pygame.draw.polygon(screen, (0, 0, 0), [
        (witch_x + 10, 157), (witch_x + 20, 152), (witch_x + 35, 157), (witch_x + 20, 162)  
    ])

    pygame.draw.polygon(screen, (0, 0, 0), [
        (witch_x-8, 165), (witch_x-18, 169), (witch_x-15, 158)  
    ])
    
    pygame.draw.line(screen, (0, 0, 0), (witch_x - 10, 165), (witch_x + 50, 170), 3)  
